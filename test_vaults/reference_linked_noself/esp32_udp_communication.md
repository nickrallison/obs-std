...
Here is a script for listening to a port and printing any [[UDP Communication|UDP]] comms that arrive on that port
...
Here is how to [[UDP Communication|UDP]] messages
