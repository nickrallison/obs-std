...
First, we calculate the eigenvalues and eigenvectors of $AA^T$ and $A^TA$. The eigenvalues of both will be the same, and they will give us the square of the singular values. The eigenvectors will give us the columns of U and V.
...
The eigenvalues of these matrices are approximately {5.46498,184.535}. Taking square roots gives us singular values in Σ: {√5.46498, √184.535}, or approximately {2.34035,13.5893}.

The corresponding normalized eigenvectors for $AA^T$ (which form U) are approximately {[-0.817415, -0.576048], [0.576048,-0.817415]}.

The corresponding normalized eigenvectors for $A^TA$ (which form V) are approximately {[0.404554,-0.914514], [0.914514,0.404554]}.
