...
Let $G$ be a group and $*$ be a binary operation on $G$. If for every pair of elements $a, b \in G$, the result of the operation $a * b$ is also in $G$, then we say that G is closed under the operation. This can be written as:
